...
#### 3.3: submitte the  commit 
 COMMIT_TAG=" fix a bug in source.mac which caused by uncommented comment.   "
...
####-----------------------3: push it to the github--------------------
 git remote add origin https://github.com/horsewave/gate_jdpet.git

## use the following to spare the enter of username and password
 git config credential.helper store
 https://github.com/horsewave/gate_jdpet.git
